...
const mockContent = {
  ...
  testimonials: [
    {
      quote: "The coaching sessions have been transformative for my career. I've gained clarity and confidence.",
      name: 'John Doe',
      role: 'Marketing Manager',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=faces',
    },
    {
      quote: 'Working with Leenders Coaching has helped me achieve my goals faster than I thought possible.',
      name: 'Jane Smith',
      role: 'Entrepreneur',
      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop&crop=faces',
    },
    {
      quote: 'The insights and strategies I gained have completely transformed my approach to leadership.',
  ...
  extendedTestimonials: [
    {
      quote: "My journey with Leenders Coaching began during a crucial career transition. The depth of understanding and personalized guidance I received was exceptional. Through our sessions, I not only achieved my immediate goals but also developed a long-term vision for my professional growth.",
      name: 'Sarah Williams',
      role: 'Senior Product Manager',
      image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=faces',
    },
    {
      quote: 'The holistic approach to coaching at Leenders has been eye-opening. We worked on both professional challenges and personal development, creating a perfect balance that led to sustainable growth in all areas of my life.',
      name: 'Robert Chen',
  ...
  render: () => (
    <>
      ...
      <SectionTimeline
        ...
        steps={[
          { title: 'Initial Consultation', description: 'Get to know each other and discuss your goals' },
          { title: 'Goal Setting', description: 'Define clear, achievable objectives' },
          { title: 'Action Plan', description: 'Create a personalized roadmap for success' },
          { title: 'Implementation', description: 'Put your plan into action with ongoing support' },
          { title: 'Progress Review', description: 'Regular check-ins to measure progress and adjust strategy' },
          { title: 'Goal Achievement', description: 'Celebrate success and set new challenges' }
        ]}
        background="purple"
      />
      <SectionTestimonial
        ...
        posts={[
          {
            ...
            description: "A guide to discovering what truly matters in your life",
