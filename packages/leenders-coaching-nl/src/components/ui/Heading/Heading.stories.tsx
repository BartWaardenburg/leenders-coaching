...
export const WithColoredBorder: Story = {
  ...
  render: (args) => (
    <div className="flex flex-col gap-8">
      <Heading {...args} showBorder borderColor="blue">Blue Border</Heading>
      <Heading {...args} showBorder borderColor="purple">Purple Border</Heading>
      <Heading {...args} showBorder borderColor="green">Green Border</Heading>
      <Heading {...args} showBorder borderColor="pink">Pink Border</Heading>
      <Heading {...args} showBorder borderColor="yellow">Yellow Border</Heading>
      <Heading {...args} showBorder borderColor="teal">Teal Border</Heading>
    </div>
  ),
};
