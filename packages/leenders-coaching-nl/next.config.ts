        ...
        headers: [
          {
            ...
            value: isDevelopment
              ...
              : `default-src 'self'; script-src 'self' 'unsafe-inline' https://challenges.cloudflare.com https://*.cloudflare.com https://vercel.live; frame-src https://challenges.cloudflare.com https://*.cloudflare.com https://vercel.live; style-src 'self' 'unsafe-inline' https://challenges.cloudflare.com https://vercel.live; connect-src 'self' https://challenges.cloudflare.com https://*.cloudflare.com https://vercel.live; img-src 'self' data: https:; frame-ancestors 'self' https://*.sanity.studio ${studioUrl} https://leenders-coaching.nl`,
          },
          {
